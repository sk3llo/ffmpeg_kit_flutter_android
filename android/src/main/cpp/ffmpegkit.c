...
const char *configClassName = "com/antonkarpenko/ffmpegkit/FFmpegKitConfig";
...
JNINativeMethod configMethods[] = {
    {"enableNativeRedirection", "()V", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_enableNativeRedirection},
    {"disableNativeRedirection", "()V", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_disableNativeRedirection},
    {"setNativeLogLevel", "(I)V", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_setNativeLogLevel},
    {"getNativeLogLevel", "()I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeLogLevel},
    {"getNativeFFmpegVersion", "()Ljava/lang/String;", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeFFmpegVersion},
    {"getNativeVersion", "()Ljava/lang/String;", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeVersion},
    {"nativeFFmpegExecute", "(J[Ljava/lang/String;)I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_nativeFFmpegExecute},
    {"nativeFFmpegCancel", "(J)V", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_nativeFFmpegCancel},
    {"nativeFFprobeExecute", "(J[Ljava/lang/String;)I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_nativeFFprobeExecute},
    {"registerNewNativeFFmpegPipe", "(Ljava/lang/String;)I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_registerNewNativeFFmpegPipe},
    {"getNativeBuildDate", "()Ljava/lang/String;", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeBuildDate},
    {"setNativeEnvironmentVariable", "(Ljava/lang/String;Ljava/lang/String;)I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_setNativeEnvironmentVariable},
    {"ignoreNativeSignal", "(I)V", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_ignoreNativeSignal},
    {"messagesInTransmit", "(J)I", (void*) Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_messagesInTransmit}
};
 ...
 * @param level log level
 */
JNIEXPORT void JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_setNativeLogLevel(JNIEnv *env, jclass object, jint level) {
 ...
 * @param object reference to the class on which this method is invoked
 */
JNIEXPORT jint JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeLogLevel(JNIEnv *env, jclass object) {
 ...
 * @param object reference to the class on which this method is invoked
 */
JNIEXPORT void JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_enableNativeRedirection(JNIEnv *env, jclass object) {
    enableNativeRedirection();
}
 ...
 * @param object reference to the class on which this method is invoked
 */
JNIEXPORT void JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_disableNativeRedirection(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeFFmpegVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jint JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_nativeFFmpegExecute(JNIEnv *env, jclass object, jlong id, jobjectArray stringArray) {
 ...
 * @param id session id
 */
JNIEXPORT void JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_nativeFFmpegCancel(JNIEnv *env, jclass object, jlong id) {
    cancel_operation(id);
}
 ...
 */
JNIEXPORT int JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_registerNewNativeFFmpegPipe(JNIEnv *env, jclass object, jstring ffmpegPipePath) {
 ...
 */
JNIEXPORT jstring JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_getNativeBuildDate(JNIEnv *env, jclass object) {
    char buildDate[10];
 ...
 */
JNIEXPORT int JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_setNativeEnvironmentVariable(JNIEnv *env, jclass object, jstring variableName, jstring variableValue) {
 ...
 */
JNIEXPORT void JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_ignoreNativeSignal(JNIEnv *env, jclass object, jint signum) {
    if (signum == SIGQUIT) {
        handleSIGQUIT = 0;
 ...
 * @param id session id
 */
JNIEXPORT int JNICALL Java_com_antonkarpenko_ffmpegkit_FFmpegKitConfig_messagesInTransmit(JNIEnv *env, jclass object, jlong id) {
